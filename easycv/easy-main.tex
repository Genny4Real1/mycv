...
\address{Via Luigi Girardi 27b}{20025 MI}{ITA}         % optional, remove/comment the line if not wanted; the "country" arguments can be omitted or provided empty
\mobile{+39 351 505 4751}                          % optional, remove/comment the line if not wanted
...
\email{and.russo.0511@gmail.com}                               % optional, remove/comment the line if not wanted
\homepage{home page}                         % optional, remove/comment the line if not wanted
\extrainfo{additional information}                 % optional, remove/comment the line if not wanted
\photo[64pt][0.4pt]{avatar.png}                       % optional, uncomment the line if wanted; '64pt' is the height the picture must be resized to, 0.4pt is the thickness of the frame around it (put it to 0pt for no frame) and 'picture' is the name of the picture file
